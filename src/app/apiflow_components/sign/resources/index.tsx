...
import GSelect from "@/app/Components/Global/GSelect";
...
export default function Resources({ clientSession, isWorkflowModal }: Props) {
  ...
  const InputArray = [
    ...
    //     formDataStore?.swagger == "Swagger URL",
    // },
    // {
    //   id: 7,
    //   label: "Interval",
    ...
    //   value: "",
    //   isVisible:
    //     formDataStore?.gateway == "API Discovery via Swagger URL" &&
    //     formDataStore?.swagger == "Swagger File",
    // },
  ];
