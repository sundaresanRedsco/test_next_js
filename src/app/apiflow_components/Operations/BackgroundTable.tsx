...
// Component
function BackgroundUrlsAccordion(props: {
  backgroundUrlData: any[];
  setBackgroundDetails: any;
}) {
  const { backgroundUrlData, setBackgroundDetails } = props;
