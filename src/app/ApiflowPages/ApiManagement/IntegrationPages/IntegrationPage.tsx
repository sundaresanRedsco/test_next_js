...
import ServiceNowImage from "../../../Assests/images/serviceNow.webp";
// import SplunkImage1 from "../../../Assests/images/Splunk-Symbol1.png";
import SplunkImage1 from "../../../Assests/images/Splunk-Symbol1.webp";
...
function IntegrationPage(props: any) {
  ...
  const handleApplicationInValidation = () => {
    ...
    if (id === "integration_page_pager_duty") {
      alert("Reach");
      console.log(pagerValues, "pagerValuespagerValues");
      const errors: any = {};
      //for empty value
  ...
  const handlePagerDuty = () => {
    const validationCheck = handleApplicationInValidation();
    console.log(validationCheck, "validationCheckvalidationCheck");
