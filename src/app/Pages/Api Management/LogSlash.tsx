...
import logstash from "../../Assests/icons/logstash.svg";
...
import {
  ...
  createTeamreducer,
  selectCurrentTeam,
} from "../../Redux/manageTeam/teamReducer";
...
function LogSlash() {
  ...
  console.log("CurrentTeamLogSlash: ", currentTeam);
  ...
  console.log(projectsListSolrOffset, "projectsListSolrOffset");
...
`;
  ...
  console.log(instancesIds, "instancesIdsinstancesIds");
  ...
  console.log(discoveryStatus, "discovery1discovery1discovery1");
  ...
  console.log(instanceId.enable, "instanceId.enable");
