...
import PlusIcon from "../../Assests/icons/circleplus.svg";
...
import AwsImportPopup from "../../Components/ApiManagement/AwsImportPopup";
import ImportLogsSteps from "../../Components/ApiManagement/ImportLogsSteps";
import SplunkImage1 from "../../Assests/images/Splunk-Symbol1.png";
import ServiceNowImage from "../../Assests/images/serviceNow.png";
import dutyImage from "../../Assests/images/pager.png";
import jiraImage from "../../Assests/images/jira-log.png";
...
export default function Integrations() {
  ...
  console.log(selectedVal, "selectedValselectedVal");
  ...
  console.log(pagerValues?.api_key, "pagerValues");
  console.log(jiraValues?.projectKey, "jiraEmail");
  ...
  console.log(gateWaysClickableType, "gateWaysClickableType");
  ...
  const handleConfigureBtn = (
    ...
    console.log("ConfigureValues: ", val);
  ...
  const handleStatusBtn = (val: any, index: any) => {
    console.log("StatusUpdateData: ", val);
  ...
  const handleApplicationInValidation = () => {
    ...
    if (selectedVal === "Service Now") {
      ...
      console.log(serviceNowValues?.api_url, "api_url");
  ...
  const handlePagerDuty = () => {
    ...
    if (validationCheck === true) {
      ...
      if (integrationResponse?.length > 0) {
        ...
        console.log(splunkSiem, "splunkSiem");
                            ...
                            <Grid item xs={2} md={3} sm={4}>
                              ...
                              >
                                ...
                                >
                                  ...
                                  {/* <Tooltip
                                                                                arrow
                                                                                title={`Click here to switch to ${val?.is_enable === true ? "InActive" : "Active"}`}>
                                                                                <Chip
                                                                                    label={
                                                                                        val?.is_enable === true
                                                                                            ? "Active" : "Inactive"
                                                                                    ...
                                                                                    sx={{
                                                                                        backgroundColor:
                                                                                            val?.is_enable === true
                                                                                                ? "rgba(33, 150, 83, 0.08)" : "rgb(243 71 71 / 23%)",
                                                                                        // : val?.status === false
                                                                                        //     ? "rgb(243 71 71 / 23%)"
                                                                                        //     : "",
                                                                                        color:
