...
import GlobalIntegrationSidebar from "@/app/apiflow_components/Integration/GlobalIntegrtions/globalIntegrationSidebar";
            ...
            {activeButton.section === "GLOBAL_INTEGRATION" && (
              <>
                {activeButton.label === "Service Now" ? (
                  <>
                    <IntegrationPage id={"integration_page_service_now"} />
                  </>
                ) : activeButton.label === "Splunk" ? (
                  <>
                    <IntegrationPage id={"integration_page_splunk_siem"} />
                  </>
                ) : (
                  ""
                )}
            ...
            {activeButton.section === "INCIDENT_TASK_MANAGEMENT" && (
              <>
                ...
                {activeButton.label === "Pagerduty" ? (
                  <>
                    <IntegrationList id={"PAGER_DUTY"} />
                  </>
                ) : activeButton.label === "Jira" ? (
                  <>
                    <IntegrationList id={"JIRA"} />
                  </>
                ) : (
                  ""
                )}
