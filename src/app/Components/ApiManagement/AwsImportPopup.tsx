...
import Aws from "../../Assests/icons/AwsIcon.svg";
import {
  CardImage,
  PrimaryTypography,
  SecondaryTypography,
...
import azuer from "../../Assests/images/azure-logo.png";
import Paper from "@mui/material/Paper";
import Grid from "@mui/material/Grid";
import AzureImage from "../../Assests/images/azure-logo.png";
import CloudImage from "../../Assests/images/Google-Cloud.jpg";
...
function AwsImportPopup(props: any) {
  ...
  console.log(apiGateway.subscription_id);

  const [sdkType, setSdkType] = useState(edits ? gatewayData?.type : "");
  console.log(gatewayData?.type, "gatewayData");
  ...
  console.log(extractedData, "extractedDatas");

  console.log(errorHandingImports, "errorHandingImports");

  console.log(emails, "emailsemailsemails");

  console.log(selectedRegionName, "selectedRegionName");
  console.log(intervalSeconds.toString, "intervalSeconds");
  console.log(apiGatewayKeys, "apiGatewayKeysapiGatewayKeys");
  console.log(currentTeam, "currentTeamcurrentTeam");
    ...
    dispatch(ImportApiGateway(addGatewayDetails))
      ...
      .catch((error: any) => {
        ...
        try {
          ...
          console.log(parsedError, "parsedErrordfdf");
        } catch (parseError) {
        ...
        // console.log(errorData,"newErrorData");
  ...
  console.log(apiGateway?.client_id, "apiGateway?.accessKey");
  ...
  //     console.log(extractedData, "extractedData"); // Log the extracted data
  //   }
  // }, [errorHandingImports]);
  ...
  const importsUpdateApigate = () => {
    ...
    console.log("apiGatewayKeys:", apiGatewayKeys);
    console.log("kongGateway:", kongGateway);
    ...
    console.log("updateApisGate", updateApisGate);
    if (hasNoErrors) {
  ...
  console.log(apiGateway?.name, "apiGateway?.name");
                        ...
                        {field.id === "region" ? (
                          ...
                          <div>
                            ...
                            <ApiTextField
                              ...
                              value={
                                apiGateway[field.id as keyof ApiGatewayType]
                              } // Assuming you're using controlled inputs
                              onChange={(e: any) =>
