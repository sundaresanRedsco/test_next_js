...
export const apiTestingDashboardSlice = createSlice({
...
export type apiTestingDashboardReducer = ReturnType<
  typeof apiTestingDashboardSlice.reducer
>;

export default apiTestingDashboardSlice.reducer;
